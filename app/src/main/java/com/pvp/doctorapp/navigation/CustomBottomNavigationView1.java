...
public class CustomBottomNavigationView1  extends BottomNavigationView implements BottomNavigationView.OnNavigationItemSelectedListener {
    ...
    private void init() {
        ...
        mPaint.setColor(ContextCompat.getColor(getContext(), R.color.whiteshade));
